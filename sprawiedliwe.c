...
pthread_mutex_t mutex_czytelnia; // Blokada chroniaca wejscie do czytelni
pthread_mutex_t
    mutex_aktywni; // Mutex chroniacy wspoldzielony licznik czytelnikow
pthread_mutex_t
    mutex_log; // Mutex izolujacy operacje wejscia/wyjscia (logowanie)

// Funkcja atomizujaca zmiane wartosci logowania i wypisywanie stanu
